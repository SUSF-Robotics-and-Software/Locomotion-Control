...
def calc_ackermann(self, mnvr_params):
    """
        ...
        ----
            self
                LocoCtrl module state

            mnvr_params
                Dictionary of parameters for the manoeuvre, see
                docs/spec
        ...
        -------
            `namedtuple` of two members:
                act_dems:
                    Actuator demands, an instance of ActDems
                status_rpt:
                    Status report dictionary, to be populated with
