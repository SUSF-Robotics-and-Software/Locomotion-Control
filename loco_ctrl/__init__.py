...
class LocoCtrl:
    """
        ...
        commands into lower level actuator commands.
        ...
        -------
            LocoCtrl.get_act_telem():
                Retrieve actuator telemetry for use in additional data
                processing. See function definition file for more information.

            LocoCtrl.do_mnvr_ctrl(mnvr_cmd):
                Command the actuators to perform the given manoeuvre. mnvr_cmd
                must be valid as per the module spec. See function definition
